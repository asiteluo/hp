...
import com.example.demo2.token.PassToken;
import com.example.demo2.token.UserLoginToken;
...
public class AuthenticationInterceptor implements HandlerInterceptor {
     ...
     * （如调用下一个拦截器或处理器）或者接着执行postHandle()和afterCompletion()；false表示流程中断，
     * 不会继续调用其他的拦截器或处理器，中断执行。
     * @throws Exception
     */
    @Override
